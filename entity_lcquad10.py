...
if __name__ == "__main__":
    ...
    with open('data/lcquad10/data.json', 'r', encoding='utf-8') as f:
        data = json.load(f)
    ...
    ds = LC_Quad10_Linked(path="./data/lcquad10/linked_answer.json")
    ds.load()
    ds.parse()
    ...
    # custom_query = "What is the appliance which uses the central processing unit manufactured by Marvell Technology Group?"
    ...
    # earl = get_earl_entities(custom_query)
    # print(earl)
    ...
    with open('data/lcquad10/entity_lcquad.json', "w") as data_file:
