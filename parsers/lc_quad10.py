...
class LC_Quad10:
    ...
    def __init__(self, path="./data/lc-quad10/data.json"):
        self.raw_data = []
        self.qapairs = []
        self.path = path
        self.parser = LC_Quad10Parser()
...
class LC_Quad10Parser(AnswerParser):
    def __init__(self):
        super(LC_Quad10Parser, self).__init__(DBpedia(one_hop_bloom_file="./data/blooms/spo1.bloom"))
