...
if __name__ == "__main__":
    ...
    with open('learning/transformers/data/lcquad10/lcquad10_test.json', 'r', encoding='utf-8') as f:
        data = json.load(f)

    properties = preprocess_relations('dbpedia_3Eng_property.ttl', True)
    # print('properties: ', len(properties))
    # print(f'keys: { properties.keys()}')
    # print(f'values: { properties.values()}')
    ...
    with open('./data/lcquad10/entity_lcquad10_test.json', "w") as data_file:
